...
const SignInPage: React.FC = () => {
  ...
  const handleSocialLogin = async (provider: 'google' | 'github') => {
    ...
    // For production, redirect to actual OAuth flow
    if (provider === 'google') {
      setError('Google login setup required. Please contact administrator.');
    } else if (provider === 'github') {
      setError('GitHub login setup required. Please contact administrator.');
    }
  };
    ...
    <div className="min-h-screen bg-[#0a0b1e] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="bg-[#1a1b3a] rounded-2xl p-8 shadow-2xl border border-gray-800">
          ...
          <p className="text-gray-400 text-center mb-8">Sign in to access your financial dashboard.</p>
